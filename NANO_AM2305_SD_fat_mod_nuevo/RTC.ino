...
//    mensajeSalida = "01," + String(fecha) + "," + idInvernadero + "," + String(t, 2) + "," + String(h, 2) + ";";
  ...
  if (minuto % intervalo == 0 && !unicaVez1 && segundo==10 && h >= 0 && t >= 0 )
  {
    unicaVez1 = true;
    esp.print(mensajeSalida);
    Serial.print(mensajeSalida);
   ...
   if (minuto % intervalo == 0 && !unicaVez2 &&segundo==30  && h >= 0 && t >= 0 )
  {
    unicaVez2 = true;
    esp.print(mensajeSalida);
    Serial.print(mensajeSalida);
  ...
  if (minuto % intervalo == 0 && !unicaVez3 &&segundo==50  && h >= 0 && t >= 0 )
  {
    unicaVez3 = true;
    esp.print(mensajeSalida);
    Serial.print(mensajeSalida);
