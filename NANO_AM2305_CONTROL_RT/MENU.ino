...
void horasAsp() {
  lcd.setCursor(0, 0); imprimir("Horario Aspersion ");
  lcd.setCursor(0, 1);
  if (hora1Asp < 10) {
    imprimir("0");
  }
...
void modificarParam() {
  switch (parametro) {
    ...
    case 3:
      ...
      lcd.setCursor(0, 0); imprimir("Asper ON      ");
      imprimirHM();
      break;
    case 4:
      if (subEstado == 0) {
      ...
      lcd.setCursor(0, 0); imprimir("Asper OFF      ");
      imprimirHM();
      break;
    case 5:
      if (subEstado == 0) {
    ...
    case 9:
      ...
      lcd.setCursor(0, 0); imprimir("Habilitar Asper    ");
      lcd.setCursor(0, 1);
      if (valorH == 0) {
        imprimir("OFF   ");
      } else {
