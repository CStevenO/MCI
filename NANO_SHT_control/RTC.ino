...
//                  }
 ...
 if (minuto % intervalo == 0 && !unicaVez && segundo == 0 && h >= 0 && t >= 0 ) 
  ...
  if(hora== 4 && minuto == 52 && segundo >20 && segundo <25)
  {
     asm("jmp 0x0000");
  }

   if(hora== 11 && minuto == 52 && segundo >20 && segundo <25)
  {
     asm("jmp 0x0000");
  }

   if(hora== 16 && minuto == 52 && segundo >20 && segundo <25)
  {
     asm("jmp 0x0000");
  }

  if(hora==23 && minuto == 52 && segundo >20 && segundo <25)
  {
     asm("jmp 0x0000");
  }
}
